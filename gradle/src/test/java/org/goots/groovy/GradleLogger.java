                ...
                implements Logger
{
    ...
    {
        System.out.println( MessageFormatter.format( format, arg ) );
    }
    ...
    {
        System.out.println( MessageFormatter.format( format, arg1, arg2 ) );
    }
    ...
    {
        System.out.println( MessageFormatter.format( msg, t ) );
    }
    ...
    {
        System.out.println( MessageFormatter.format( message, throwable ) );
    }
    ...
    {
        System.out.println( MessageFormatter.format( message, objects ) );
    }
